    ...
    <Section id='depoimentos' className='bg-secondary'>
      <Container>
        <div className='space-y-2 text-center lg:space-y-3'>
          <Tagline>Depoimentos</Tagline>
          <Headline>Empresários que já economizam</Headline>
          <Body>
            Avaliação média de 4.9/5 em +350 avaliações. Mais de 5.200 vidas
            protegidas e empresas satisfeitas em todo o Brasil.
          </Body>
        </div>
